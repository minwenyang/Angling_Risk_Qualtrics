...
/* ************************************ */
var repo_site = "https://minwenyang.github.io/Angling_Risk_Qualtrics/"
...
function makeFish(fish_num) {
	...
	*/
	...
	for (i = 0; i < fish_num - 1; i++) {
		red_fish_num += 1
		if (weather == "Sunny") {
			$('.lake').append('<div class = redfish id = red_fish' + red_fish_num + ' src=' + repo_site + 'images/red_fish.png></div>')
		}
	}
	if (weather == "Sunny") {
		$('.lake').append('<div class = bluefish id = blue_fish src=' + repo_site + 'images/blue_fish.png></div>')
	}
	place_fish()
	if (weather == "Sunny") {
